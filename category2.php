			...
			<div class="row">
				<div class="col-md-12">
					<div class="search-result bg-gray">
						<h2>Results  "<?php echo $varLike ?>"</h2>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-9">
					<div class="category-search-filter">
						<div class="row">
							<div class="col-md-6">
								<strong>All pets with some <?php echo $varLike ?> fur.</strong>
					...
					<div class="product-grid-list">
						<div class="row mt-30">
							...
							<?php $sql = "SELECT * FROM pets WHERE an_color LIKE '%$varLike%'";
							$result = $conn->query($sql);
							if ($result->num_rows > 0) {
								while($row = $result->fetch_assoc()) {
